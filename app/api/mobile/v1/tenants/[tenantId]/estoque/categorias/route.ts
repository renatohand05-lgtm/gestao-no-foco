...
import { composeStockCategories } from "@/lib/mobile/stock-compose";
...
/** GET /api/mobile/v1/tenants/:tenantId/estoque/categorias */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const dto = await composeStockCategories({
