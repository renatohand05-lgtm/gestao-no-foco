...
import { composeStockSuppliers } from "@/lib/mobile/stock-compose";
...
/** GET /api/mobile/v1/tenants/:tenantId/estoque/fornecedores */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const dto = await composeStockSuppliers({
