...
import { composeAccountsReceivable } from "@/lib/mobile/finance-compose";
...
/** GET /api/mobile/v1/tenants/:tenantId/financeiro/accounts-receivable */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const dto = await composeAccountsReceivable({
