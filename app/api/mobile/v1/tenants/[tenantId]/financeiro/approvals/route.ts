...
import { composeFinanceApprovals } from "@/lib/mobile/finance-compose";
...
/** GET /api/mobile/v1/tenants/:tenantId/financeiro/approvals */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const dto = await composeFinanceApprovals({
