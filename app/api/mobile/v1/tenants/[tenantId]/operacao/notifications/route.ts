...
import { composeOpsNotifications } from "@/lib/mobile/operations-compose";
...
/** GET /api/mobile/v1/tenants/:tenantId/operacao/notifications */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const dto = await composeOpsNotifications({
