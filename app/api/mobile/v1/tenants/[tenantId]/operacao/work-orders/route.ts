...
import { composeOpsWorkOrders } from "@/lib/mobile/operations-compose";
...
/** GET /api/mobile/v1/tenants/:tenantId/operacao/work-orders */
export async function GET(request: Request, context: RouteContext) {
  ...
  try {
    const dto = await composeOpsWorkOrders({
