    ...
    >
      {panels.map((panel) => {
        ...
        return (
          <section
            key={panel.id}
            className="overflow-hidden rounded-2xl border border-border/50 bg-card/70 dark:bg-[var(--brand-graphite-elevated)]/70"
          >
            <button
              type="button"
              ...
              className="flex w-full items-center justify-between gap-3 px-4 py-3.5 text-left transition-colors hover:bg-muted/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[var(--brand-gold)]/40"
            >
