...
export const FINANCE_NAV_ITEMS: readonly FinanceNavItem[] = [
  ...
  },
  {
    ...
    label: "Dashboard CFO",
    group: "relatorios",
    permission: "financeiro.cfo.visualizar",
    enterprise: true,
  },
  {
    href: "dre",
  ...
  {
    href: "aging",
    label: "Aging / Inadimplência",
    group: "operacoes",
    permission: "financeiro.aging.visualizar",
    enterprise: true,
  },
  {
    href: "orcamento",
    label: "Orçamento",
    group: "planejamento",
    permission: "financeiro.orcamento.visualizar",
    enterprise: true,
  },
  {
    href: "tributos",
