...
export function ContaBancariaDetail({ tenantSlug, item }: Props) {
  return (
    <div className="space-y-6">
      ...
      <SectionCard title="Dados da conta">
        <FormGrid>
          <DetailItem label="Tipo" value={getContaBancariaTipoLabel(item.tipo)} />
          ...
          <DetailItem label="Saldo inicial" value={formatCurrency(item.saldo_inicial)} />
        </FormGrid>
      </SectionCard>
