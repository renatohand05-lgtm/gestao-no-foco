...
| `IMPORT_ASYNC_PROCESSING_ENABLED` | off | Processamento assíncrono (não implementado) |
| `ALLOW_IMPORT_MEMORY` | off | Emergência: permite memória em NODE_ENV=production |
