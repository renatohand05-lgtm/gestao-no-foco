...
| 22 | build gerada | **119** _(após EAS)_ |
| 23 | Build ID | _(após EAS)_ |
| 24 | commit SHA | _(após commit)_ |
| 25 | HEAD == origin/main | _(após push)_ |
