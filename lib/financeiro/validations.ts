...
export const contaReceberFormSchema = z
  .object({
    ...
    categoria_financeira_id: z
      .string()
      .uuid("Selecione uma categoria financeira."),
    centro_custo_id: z.string().uuid("Selecione um centro de custo."),
    plano_conta_id: z.string().uuid("Selecione um plano de contas."),
