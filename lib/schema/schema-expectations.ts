...
export const SCHEMA_EXPECTATIONS: SchemaExpectation[] = [
  {
    ...
    migration: "20260719 / 20260721 / 20260726 / 20260812 / 20260802 / 20260814",
    critical: true,
    notes: "Sprint 29.10 — create lead exige valor_estimado (60812) + ensure 60814.",
  },
  {
    ...
    migration: "20260813 / 20260814",
    critical: true,
    notes: "Probe UI Compras (ready) depende desta tabela.",
  },
  {
    table: "crm_oportunidades",
    columns: ["tenant_id", "cliente_id", "titulo", "stage_key", "status", "deleted_at"],
    migration: "20260812 / 20260802 / 20260814",
    critical: true,
  },
  {
    table: "fornecedores",
  ...
  },
  {
    ...
    columns: ["tenant_id", "role", "permission_key", "allowed"],
    migration: "20260728",
    critical: true,
  },
  {
    table: "venda_devolucoes",
    columns: ["tenant_id", "venda_id", "motivo", "valor_total", "status"],
    migration: "20260728",
    critical: false,
  },
  {
...
export const RPC_EXPECTATIONS: RpcExpectation[] = [
  ...
  {
    name: "abrir_os_com_cliente_atomico",
    migration: "20260728_oficina_fluxo_integrado",
    critical: true,
  },
  {
    name: "ensure_consumidor_balcao",
    migration: "20260728_oficina_fluxo_integrado",
    critical: true,
  },
  {
