-- Migration: ajuste faturamento — forma opcional quando não gera financeiro
-- Execute manualmente no Supabase SQL Editor
-- Requer:
--   20260708_rpc_faturar_cancelar_venda.sql
--   20260708_vendas_classificacao_financeira.sql (opcional, para propagar classificação)
...
comment on function public.faturar_venda_atomico(uuid, uuid, uuid) is
  'Fatura venda com baixa de estoque; gera contas a receber somente quando gera_financeiro = true';
